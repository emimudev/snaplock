...
export default function Sidebar() {
  ...
  return (
    <div className={'relative top-[56px] flex lg:top-0'}>
      <aside
        className={`absolute left-0 z-30 flex h-[calc(100vh-56px)] w-[256px] flex-1 flex-col lg:fixed lg:h-screen ${sidebarOpen} transform-gpu overflow-y-auto border-r border-[rgba(24,24,27,.1)] bg-white pb-2 transition-transform ease-in-out dark:bg-[#18181b] lg:max-w-[256px] lg:translate-x-0 dark:lg:border-white/10`}
      >
