...
export default function AsideItemViewer() {
  ...
  return (
    <div
      className={`layout-aside-item-viewer can-disable-folder flex-0 hidden transform-gpu overflow-x-hidden border-l transition-[min-width,width] dark:border-white/10 md:block ${
